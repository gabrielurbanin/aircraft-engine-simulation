from ISA_Calculator.isacalc.main_executable import get_atmosphere, calculate_at_h
...
T0, P0, d0, a0, mu0 = calculate_at_h(H, atmosphere)
T0 = 288.15  # K
gamma_c = 1.4
cp_c = 1004  # J/(kg.K)
gamma_t = 1.3
...
FC_m0 = 1/(1 + alfa) * a0 * ((1 + f) * V9_a0 - M0 + 0 * (1 + f) * R_t/R_c * T9_T0/V9_a0 * (1 - P0_P9)/gamma_c)  # N/(kg/s) -> conferir termo 0
